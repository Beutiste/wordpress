...
if(!function_exists('md_theme_menu')) {
    ...
    if ( function_exists( 'register_nav_menu' ) ){
            ...
            register_nav_menu('onepage-menu',__( 'One Page Menu' ));
        }
	}
...
if(!function_exists('md_theme_scripts')) {
    ...
    function md_theme_scripts() {
        ...
        if( is_page_template('tpl-onepage.php') ){
            wp_enqueue_style( 'md-onepage', MD_THEME_URI . '/assets/css/md-onepage.css', '', '', 'all' );
        }
    }
